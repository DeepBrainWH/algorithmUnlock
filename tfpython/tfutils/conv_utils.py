...
def max_pooling(X, kernel_size, stride, padding='SAME', name='pooling_layer'):
    """
    :param X: input tensor 4-dimension.
    :param kernel_size: kernel size: 2-dimension.
    :param stride: stride, 2 dimension.
    :param padding: 'SAME' or 'VALID'
    :param name: layer's name
    :return: value of max pooling.
    """
    return tf.nn.max_pool(X, [1, kernel_size[0], kernel_size[1], 1], [1, stride[0], stride[1], 1], padding, name=name)
